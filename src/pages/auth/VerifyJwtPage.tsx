...
export default function VerifyJwtPage() {
  ...
  return success ? (
    <>
      ...
      <Typography sx={{ color: 'text.secondary', mb: 5 }}>Your email has been verified.</Typography>
    ...
    <>
      ...
      <Typography sx={{ color: 'text.secondary', mb: 5 }}>Please check yoor E-mail.</Typography>

      <Typography variant="body2" sx={{ my: 3 }}>
        Didn&apos;t receive an E-mail? &nbsp;
        <RouterLink to={PATH_AUTH.resend}>
          {' '}
          <Link variant="subtitle2">Resend E-mail</Link>
        </RouterLink>
      </Typography>
